...
class CreditDefaultData:
    ...
    def __init__(self, seed=1):
        self.path = '/data/default of credit card clients.xls'
        self.dataset_name = 'Credit Default Dataset'
        self.seed = seed
        self.num_features = None
        self.is_data_balanced = False
        self.loaded_data = None
        self.class_col_name = 'default payment next month'
        self.train_x = None
        self.train_y = None
        self.test_x = None
        self.test_y = None

    def is_data_balanced(self):
        """
    ...
    def load_data(self):
        ...
        """
        self.loaded_data = pd.read_excel(self.path, header=1, index_col=0)
    ...
    def split_data_train_test(self, test_size=0.3):
        ...
        :return:
        """
        self.train_x,  self.test_x, self.train_y, self.test_y = train_test_split(X,
                                                                                 Y,
                                                                                 test_size = test_size,
